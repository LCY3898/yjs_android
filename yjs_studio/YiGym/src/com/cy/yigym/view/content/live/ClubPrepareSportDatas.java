 ...
 */
public class ClubPrepareSportDatas extends BaseView {
    ...
    public ClubPrepareSportDatas(Context context) {
        super(context);
    }

    public ClubPrepareSportDatas(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

 ...
 */
public class CharmRankListAdapter extends AdapterBase<RankEntity> {

    DecimalFormat df= new DecimalFormat("######0.00");

    public CharmRankListAdapter(Context context, List<RankEntity> listItems){
    ...
    protected View getItemView(int position, View convertView, ViewGroup parent, RankEntity entity) {
        ...
        if(convertView==null){
           convertView=mInflater.inflate(R.layout.item_m_rank,null);
        }
        if(position==0){
        ...
        ((TextView)getHolderView(convertView,R.id.tvNumber)).setText(entity.getPeopleNumber() + "");

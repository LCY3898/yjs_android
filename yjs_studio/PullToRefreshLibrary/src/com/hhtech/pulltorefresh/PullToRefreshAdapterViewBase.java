...
import com.hhtech.pulltorefresh.internal.EmptyViewMethodAccessor;
import com.hhtech.pulltorefresh.internal.IndicatorLayout;
...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
	...
	private final static int INDICATOR_RIGHT_PADDING_IN_DIP = 10;
	...
	private void addIndicatorViews() {
		...
		if (mode.showHeaderLoadingLayout() && null == mIndicatorIvTop) {
			...
			params.rightMargin = DimenUtils.dpToPx(INDICATOR_RIGHT_PADDING_IN_DIP);
